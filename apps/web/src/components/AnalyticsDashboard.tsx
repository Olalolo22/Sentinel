  ...
  return (
    <div className="bg-dot-grid min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate-in fade-in duration-300">
        ...
        {/* Metric Cards Row (Solid Dark Cards) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          
          <div className="p-5 rounded-2xl card-solid-dark space-y-2">
          ...
          <div className="p-5 rounded-2xl card-solid-dark space-y-2">
            ...
            <div className="text-2xl font-extrabold text-violet-400 font-mono">27 Rules</div>
            <div className="text-[11px] text-violet-300 font-mono">Stage 4 Active</div>
          </div>

        </div>

        {/* Threat Taxonomy Distribution (Solid Dark Card) */}
        <div className="card-solid-dark p-6 rounded-2xl space-y-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { tag: "T2", name: "Zero-Width Steganography & Tag Smuggling", count: 88, percentage: 28, color: "bg-violet-500" },
