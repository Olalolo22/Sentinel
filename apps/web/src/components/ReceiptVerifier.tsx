  ...
  return (
    <div className="bg-dot-grid min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate-in fade-in duration-300">
        ...
        {/* Input Box & Action (Frosted Glass Card) */}
        <div className="card-frosted-glass p-6 rounded-2xl space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold text-xs shadow-lg shadow-cyan-500/20 whitespace-nowrap flex items-center justify-center gap-2 transition-all cursor-pointer disabled:opacity-50"
            >
        ...
        {verificationResult && (
          <div className="card-solid-dark p-6 rounded-2xl space-y-6 animate-in fade-in duration-300">
            ...
            {/* Detailed Verification Checks Grid */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              <div className="p-4 rounded-xl card-solid-dark border border-slate-800 space-y-1">
            ...
            {/* Receipt Payload JSON (Outlined Card Treatment) */}
            {verificationResult.receipt && (
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-mono text-slate-400">
                  <span>Decoded Verified Receipt Payload:</span>
                </div>
                <pre className="p-4 rounded-xl card-outlined text-xs text-cyan-300 font-mono overflow-x-auto">
